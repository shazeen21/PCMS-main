...
if(isset($_POST['submit'])) { 
  ...
  if($USN !='' || $email !='') {
    if($USN == $sun) {
      ...
      // Changed column name to PUDip to match database structure
      $stmt = mysqli_prepare($connect, "INSERT INTO `basicdetails` (`FirstName`, `LastName`, `USN`, `Mobile`, `Email`, `DOB`, `Sem`, `Branch`, `SSLC`, `PUDip`, `BE`, `Backlogs`, `HofBacklogs`, `DetainYears`, `Approve`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, '0')");
