        ...
        <nav id="mainNav" class="navbar navbar-default navbar-fixed-top" style="background:black">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand page-scroll" href="http://www.cittumkur.org">Narsee Monjee Institute of Technology</a>
                </div>
        ...
        <div class="footer">
			<div class="container">
				...
				<div class="col-md-3 get_in_touch ftr">
					<h3>GET IN TOUCH</h3>
					<p>Kharghar, Sector 36</p>
					<p>Navi Mumbai, India</p>
					<p>99873 06868</p>
					<a href="mailto:shazzzzooop@gmail.com">cittumkur@rediffmail.com</a>
				</div>
